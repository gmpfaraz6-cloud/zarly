  ...
  return (
    <div className="auth-container">
      <div className="auth-card">
        ...
        <h1 className="auth-title">Create a Shopify account</h1>
        <p className="auth-subtitle">One last step before starting your free trial.</p>
        ...
        <form className="auth-form" onSubmit={handleEmailSubmit}>
          ...
          >
            {loading ? 'Loading...' : showPasswordField ? 'Create account' : 'Continue with email'}
          </button>
        ...
        <div className="auth-footer-link">
          Already have a Shopify account? <Link to="/admin">Log in →</Link>
        </div>
